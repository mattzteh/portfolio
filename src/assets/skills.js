export const skills = (
    ...
    <ul>
        ...
        <li><i className="fa-solid fa-chevron-right"></i>SQL</li>
        <li><i className="fa-solid fa-chevron-right"></i>React</li>
        <li><i className="fa-solid fa-chevron-right"></i>Node.js</li>
        <li><i className="fa-solid fa-chevron-right"></i>Redux.js</li>
        <li><i className="fa-solid fa-chevron-right"></i>Express.js</li>
